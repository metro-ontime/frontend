...
class DataLoader extends Component {
  ...
  componentDidMount() {
    axios
      .all([
        axios.get('https://s3-us-west-1.amazonaws.com/h4la-metro-performance/sample_schedule.json'),
        axios.get('https://s3-us-west-1.amazonaws.com/h4la-metro-performance/sample_trips.json'),
      ])
      .then(
        axios.spread((schedule, actual) => {
        ...
        {this.state
          ...
          && trips && (
            <div>
              <div className="date">
                <b>Date: </b>
                Tuesday, October 30, 2018 (vertical axes showing incorrect times due to timezone
                error)
              </div>
              <Marey
                schedule={schedule}
